...
#connect to db
uri = 'mongodb+srv://MedYassinKlabi:Dik1sTy55Tk1W2Fz@network.p80bj.mongodb.net/network?retryWrites=true&w=majority'
client = pymongo.MongoClient(uri)
db = client.get_database('network')
...
@app.route('/')
def root():
    return "Bienvenue à Mynetwork API"
